 ...
 * @final
 */
class installerPimcore_Bundle_InstallBundle_InstallerKernelProdDebugContainer extends Container
{
    ...
    {
        $this->privates['monolog.handler.main'] = $instance = new \Monolog\Handler\StreamHandler((\dirname(__DIR__, 3).'/logs/prod.log'), 100, true, NULL, false);
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/installerPimcore_Bundle_InstallBundle_InstallerKernelProdDebugContainer.xml'); break;
    ...
    {
        return [
            'kernel.root_dir' => \dirname(__DIR__, 2),
            ...
            'kernel.container_class' => 'installerPimcore_Bundle_InstallBundle_InstallerKernelProdDebugContainer',
            'secret' => 'installer-5fd657cc46b499.76311951',
            ...
            'kernel.secret' => 'installer-5fd657cc46b499.76311951',
            ...
            'router.cache_class_prefix' => 'installerPimcore_Bundle_InstallBundle_InstallerKernelProdDebugContainer',
